import { h, render, rerender, Component } from '../../src/preact.js';
/** @jsx h */
...
describe('Components', () => {
    ...
    beforeEach( () => {
        let c = scratch.firstElementChild || scratch.firstChild;
    ...
    it('should not recycle common class children with different keys', () => {
        ...
        // algorithm change, same to react
        expect(scratch.textContent, 'new component without key re-rendered').to.equal('F');
        expect(Comp.prototype.componentWillMount).to.have.been.called;
        expect(sideEffect).to.have.been.called;
